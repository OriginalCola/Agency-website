    ...
    return (
        <section
            ...
            <div className='grid desktop:grid-cols-4 gap-y-10 gap-x-5 desktop:mx-[10.625rem] desktop:mt-[8rem] tablet:mt-[4rem] mobile:mt-[1.5rem] mobile:grid-cols-2 mobile:mx-[2rem] tablet:mx-[5rem]'>
                <div className={cardStyle}><img className={imgStyle} src="/icona1.png"></img><h1 className={textStyle}>Analiza rynku i doposawanie trendom</h1></div>
                <div className={cardStyle}><img className={imgStyle} src="/icon2.png"></img><h1 className={textStyle}>Tworzenie stron oraz aplikacji</h1></div>
            ...
            <div className='grid desktop:grid-cols-4 gap-y-10 gap-x-5 desktop:mx-[10.625rem] mt-[2rem] tablet:grid-cols-2 mobile:grid-cols-2 tablet:mx-[5rem] mobile:mx-[2rem] '>
                <div className={cardStyle}><img className={imgStyle} src="/icon3.png"></img><h1 className={textStyle}>Zwiększanie zainteresowania sztuką pisaną</h1></div>
                <div className={cardStyle}><img className={imgStyle} src="/icon4.png"></img><h1 className={textStyle}>Treści umieszczane na platformach social media</h1></div>
                <div className={cardStyle}><img className={imgStyle} src="/icon5.png"></img><h1 className={textStyle}>Chwylity marketing w social media </h1></div>
                <div className={cardStyle}><img className={imgStyle} src="/icon6.png"></img><h1 className={textStyle}>Zwiększenie klikalności w Google</h1></div>
            </div>
        </section>
    );
}
