export default function Services() {
    ...
    return (
        <section
            id='services'
            className='pt-[5rem]'>
                <div className='grid desktop:grid-cols-4 gap-y-10 gap-x-5 desktop:mx-[10.625rem] desktop:mt-[8rem] tablet:mt-[4rem] mobile:flex mobile:flex-col-reverse mobile:mx-[2rem] tablet:mx-[5rem]'>
                ...
                <div className='col-span-2 desktop:h-[15rem] tablet:h-[12rem] mobile:h-[10rem] flex flex-col justify-center items-center desktop:ml-[2rem] tablet:order-first'>
