            ...
            <div className='flex items-center flex-row justify-between'>
                <div className='flex flex-col mt-[5rem] mobile:mt-[10rem]'>
                    <div className='ml-[2rem] desktop:ml-[10.625rem] tablet:ml-[5rem] max-w-[40rem]'>
                        <h1 className='text-transparent desktop:text-[4rem] tablet:text-[2.5rem] mobile:text-[2rem] tracking-wide leading-tight font-[500] pb-[0.5rem] gradient-text animate-gradient'>ROI Agency</h1>
